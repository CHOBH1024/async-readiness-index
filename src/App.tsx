  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between">
      ...
      <main className="max-w-2xl mx-auto px-6 py-10 w-full flex-1">
        ...
        {activeTab === 'tool' && (
          <div className="bg-slate-900 border border-slate-800 p-8 rounded-2xl shadow-xl">
            <h2 className="text-xl font-bold text-white mb-2">Async Readiness Index</h2>
            <p className="text-xs text-slate-400 mb-6">조직 비동기 소통 수준 진단 & 피드백</p>
      ...
      <footer className="border-t border-slate-800 py-4 text-center text-[10px] text-slate-500">
        © 2026 Async Readiness Index. AWS Serverless Live Analytics & Community. Powered by Pomyjo.
      </footer>
    </div>
  );
}
